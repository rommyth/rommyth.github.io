  ...
  return (
    <section id='about' className='container mx-auto py-20 lg:px-0 xl:px-36 '>
      <div className='relative flex justify-center w-full  items-center'>
        <div className='absolute top-12 left-44 h-72 w-72 bg-amber-500 rounded-full -z-10 mix-blend-multiply filter blur-xl opacity-50 animate-blob animation-delay-2000'></div>
