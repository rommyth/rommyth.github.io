...
const Header = () => {
  const socials = (
    <>
      <a
        href="https://github.com/rommyth"
        aria-label="Github"
        className="text-white duration-200 ease-in-out hover:text-purple-500"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a
        href="https://dribbble.com/kharommy"
        aria-label="Dribbble"
        className="text-white duration-200 ease-in-out hover:text-purple-500"
        target="_blank"
        rel="noreferrer"
  ...
  return (
    <header
      id="home"
      className="bg-hero-pattern bg-cover relative after:absolute after:block after:w-full after:h-full after:opacity-70 after:bg-black after:bottom-zero"
    >
        ...
        <article>
          <div className="py-28 lg:py-0 lg:h-screen/4 text-white lg:flex lg:grid-cols-2 gap-12 justify-center lg:items-center">
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-16 hidden lg:flex gap-3">{socials}</div>
            </div>
